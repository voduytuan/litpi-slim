...
class Bbcode
{
    ...
    public function __construct()
    {
        ...
        // Replace [url=http://www.google.com/]A link to google[/url]
        // with <a href="http://www.google.com/">A link to google</a>
        $this->bbcode_table["/\[url=(.*?)\](.*?)\[\/url\]/is"] = function ($match) {
        ...
        $tmp = "/\[youtube\](?:http?:\/\/)?(?:www\.)?"
            ."youtu(?:\.be\/|be\.com\/watch\?v=)([A-Z0-9\-_]+)(?:&(.*?))?\[\/youtube\]/i";
        $this->bbcode_table[$tmp] = function (
            $match
        ) {
            return "<iframe class=\"youtube-player\" type=\"text/html\" width=\"640\" height=\"385\"
            src=\"http://www.youtube.com/embed/$match[1]\" frameborder=\"0\"></iframe>";
        };
    }
